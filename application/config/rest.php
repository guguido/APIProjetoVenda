...
|
*/
$config['rest_realm'] = 'WebService Wilson';
...
|
*/
$config['rest_database_group'] = 'db_venda'; // default
...
|
*/
$config['rest_keys_table'] = 'api_keys'; //keys

/*
|--------------------------------------------------------------------------
| REST Enable Keys - $codificada = sha1($string);
|--------------------------------------------------------------------------
|
| When set to TRUE, the REST API will look for a column name called 'key'.
| If no key is provided, the request will result in an error.
| To override the column name see 'rest_key_column'
|
...
|--------------------------------------------------------------------------
|
| Length of the created keys.
| Check your default database schema on the maximum length allowed
|
...
| Note: Custom headers with the X- prefix are deprecated as of 2012/06/12.
| See RFC 6648 specification for more details
|
*/
$config['rest_key_name'] = 'api_key'; // usuario/chave da API
...
$config['secret_key_name']    = 'secret_key'; // senha/secret/chave da API
...
|--------------------------------------------------------------------------
|
| When set to TRUE, the REST API will log actions based on the column names 'key', 'date', 'time' and 'ip_address'.
| This is a general rule that can be overridden in the
...
|
*/
$config['rest_enable_logging'] = false; // FALSE
...
|--------------------------------------------------------------------------
| When set to TRUE, the REST API will check the access table to see if the API key can access that controller.
| 'rest_enable_keys' must be enabled to use this
|
| Quando definido como TRUE, a API REST verificar� a tabela de acesso para ver se a chave API pode acessar esse controlador.
| 'rest_enable_keys' deve ser habilitado para usar isso.
|
| Default table schema:
...
|
*/
$config['rest_enable_access'] = false; //$config['rest_enable_access'] = FALSE;
...
| Useful if you are hosting your API on a different domain from the application that will access it through a browser.
|
*/
...
$config['allowed_cors_headers'] = [
    ...
    'api_key', 'secret_key' // headers extras pra token dinâmico ou estático
];
